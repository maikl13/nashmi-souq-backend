...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'seller_phone' => 'رقم هاتفك',
        'seller_address' => 'عنوان الاستلام',
        'buyer_phone' => 'رقم هاتف العميل',
        'buyer_address' => 'عنوان التسليم',
        'package' => 'نوع الشحنة',
        'amount' => 'الكمية',
        'details' => 'بيانات إضافية',

        'delivery_phone' => 'رقم هاتف شركة الشحن',
        ...
        'phoneoremail' => 'رقم الهاتف أو البريد الالكتروني',

        'initial_price' => 'السعر',
        'price' => 'السعر',
        'currency' => 'العملة',
        'units.*.currency' => 'العملة لخيارات المنتج',
        'units.*.initial_price' => 'سعر خيارات المنتج',
        'category' => 'القسم',
