<div class="post-ad-box-layout1 myaccount-store-settings">
    <form action="/stores/edit" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="form-group text-right">
                        ...
                        <div class="alert alert-danger text-right mt-2" style="opacity: .7;"><small>يفضل أن تكون أبعاد الصوره <span dir="ltr">1180x300 px</span>, الحد الأقصى لحجم الملف <span dir="ltr">8 MB</span>.</small></div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="form-group text-right">
                        ...
                        <div class="alert alert-danger text-right mt-2" style="opacity: .7;"><small>يفضل أن تكون أبعاد الصوره <span dir="ltr">512x512 px</span>, الحد الأقصى لحجم الملف <span dir="ltr">8 MB</span>.</small></div>
                    </div>
                </div>
            </div>
            <div class="row">
