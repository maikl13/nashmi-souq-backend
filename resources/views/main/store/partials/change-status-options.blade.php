...
@if( $package->is_pending()  )
	<div class="form-group">
	    <input type="radio" name="package_status" data-labelauty="قبول الطلب" value="approved" class="labelauty" required>
	    <input type="radio" name="package_status" data-labelauty="رفض الطلب" value="rejected" class="labelauty">
	</div>
...
@elseif( $package->is_deliverable() )
	<div class="form-group">
	    <input type="radio" name="package_status" data-labelauty="الانتقال لمرحلة التسليم" value="prepared" class="labelauty" required>
	    <input type="radio" name="package_status" data-labelauty="الغاء الطلب" value="cancelled" class="labelauty">
	</div>
...
@elseif( $package->is_rejected() )
	<div class="form-group">
	    <input type="radio" name="package_status" data-labelauty="تراجع" value="backward" class="labelauty" required>
	    <input type="radio" name="package_status" data-labelauty="{{ $package->is_prepared() ? 'تم التسليم' : 'الانتقال للمرحلة التالية' }}" value="forward" class="labelauty" {{ !$package->is_delivered() ? '' : 'disabled' }}>
	</div>
...
@elseif( $package->is_approved() )
	<div class="form-group">
	    <input type="radio" name="package_status" data-labelauty="تراجع" value="backward" class="labelauty" required>
	    {{-- @if($package->shipping > 0)
	    	<input type="radio" name="package_status" data-labelauty="بانتظار موافقة المشتري على تكاليف الشحن" value="forward" class="labelauty" disabled>
	    @else --}}
	    	<input type="radio" name="package_status" data-labelauty="الانتقال للمرحلة التالية" value="forward" class="labelauty">
	    {{-- @endif --}}
	</div>
