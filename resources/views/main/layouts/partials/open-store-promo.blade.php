            ...
            <div class="col-lg-10 offset-lg-1 d-flex justify-content-center">
                <div class="counter-box-layout1" dir="rtl">
                    <div class="item-content text-center">
                        ...
                        <div class="mb-4" style="font-size: 24px; color: white; font-weight: bold;">تواصل مع عملائك بإحترافية تامة</div>
                        <div class="item-title text-justify" style="font-weight: normal; font-size: 17px; line-height: 33px; text-align-last: center;">قم بانشاء متجرك الخاص على {{ setting('website_name') }} بخطوات سهلة و سريعة و أعرض منتجاتك بشكل احترافي لتنال ثقة العملاء , يمكنك تخصيص متجرك بشكل كامل و تحديد شعار و بانر للمتجر و ستتمكن من عرض كافة منتجاتك في الصفحة الخاصة بمتجرك بشكل جذاب</div>
