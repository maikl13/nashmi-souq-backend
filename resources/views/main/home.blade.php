...
@section('content')
    ...
    <section class="section-padding-top-heading pt-2 pb-4" style="background: rgb(248,92,112);background: linear-gradient(45deg, rgba(248,92,112,0.6) 0%, rgba(230,92,112,1) 80%);">
        <div class="container text-center">
            <div class="text-center d-inline-block text-md-right">
                ...
                <div class="p-1 d-inline-block" style="vertical-align: middle;">
                    <p class="text-white mb-0" style="font-size: 17px;max-width: 500px;">تقدم لك نشمي خدمة الشحن بأفضل الأسعار, لتتمكن من البيع بدون ان تشغل بالك بأعباء الشحن,.</p>
                    <a href="/deliver" class="btn btn-default my-3 py-2 px-4" style="background: white;">اشحن مع نشمي</a>
                </div>
            </div>
