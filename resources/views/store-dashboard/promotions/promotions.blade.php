...
@section('content')
	<div class="card">
		<div class="card-header text-right">
			<h4 class="d-inline float-right">العروض الترويجية</h4>
			<div class="float-left">
				<a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target="#add-modal">
		            <i class="fa fa-plus"></i> إضافة عرض تروويجي
		        </a>
	        </div>
		</div>
		<div class="card-body">
...
@section('modals')
	@include('store-dashboard.promotions.partials.add-modal')
@endsection

@section('scripts')
	<script> $("[type=file]").fileinput(fileInputOptions); </script>
	{!! $dataTable->scripts() !!}
	<script> var records = 'promotions'; </script>
