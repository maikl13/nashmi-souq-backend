...
trait CleanHtml {  
    ...
    public static function clean_html($html_str){
        ...
        $allowed_tags = array("html", "body", "b", "strong", "br", "em", "hr", "i", "li", "ol", "p", "s", "span", "table", "tr", "td", "u", "ul", "img", "a", "div", "iframe", "h1", "h2", "h3", "h4", "h5", "h5");
        $allowed_attrs = array ("class", "style", "href", "target", "src", "contenteditable", "allowfullscreen", "frameborder", "allow");
